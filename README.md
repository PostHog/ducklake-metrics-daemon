...
```bash
export DUCKLAKE_TENANT=megaduck
export DUCKLAKE_RDS_HOST=...
export DUCKLAKE_RDS_DATABASE=megaduck
export DUCKLAKE_RDS_USERNAME=megaduck
...
export MEGADUCK_PASSWORD=...
export PORTOLA_PASSWORD=...
